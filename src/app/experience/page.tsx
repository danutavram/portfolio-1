...
let link = [
  {
    ...
    sub: "Suspendisse potenti.",
    subTitle:
      "Nullam consequat, nunc in bibendum bibendum, felis justo luctus sem, vel laoreet urna elit sed arcu. Nullam sit amet volutpat tellus.",
    bttn: "View my work",
  },
  {
